...
class Happy(Smiley, Blinkable):
    ...
    def blink(self, delay=0.25):
        ...
        """
        # CLOSE EYES TO SIMULATE A BLINK
        self.draw_eyes(wide_open=False)
        # DISPLAY SMILEY FACE WITH THE CLOSED EYES
        self.show()
        # PAUSE FOR DELAY SET ABOVE
        time.sleep(delay)
        # OPEN EYES TO SIMULATE THE END OF THE BLINK
        self.draw_eyes(wide_open=True)
        # DISPLAY SMILEY FACE WITH OPEN EYES
        self.show()
